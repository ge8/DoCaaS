...
This is a sample template for cut-the-deck - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name cut-the-deck --query 'Stacks[].Outputs'
```
